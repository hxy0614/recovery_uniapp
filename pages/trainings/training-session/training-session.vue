<template>
  <view class="container">
    ...
    <view class="training-info">
      <view class="title">3秒慢肌训练</view>
      <view class="tag">盆底肌入门训练</view>
    </view>
...
const startTraining = () => {
  uni.navigateTo({
    url: '/pages/trainings/training-exercise/training-exercise'
  });
}
</script>
